...
from part3_stack.pipeline import build_confidence


def main() -> None:
    parser = argparse.ArgumentParser(description="Build confidence masks for Part 3 pseudo views")
